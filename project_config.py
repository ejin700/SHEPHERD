...
PROJECT_DIR = Path("/home/azureuser/dataverse_files/") # Path('PATH/TO/SHEPHERD')
CURR_KG = '8.26.24' 
...
MY_DATA_DIR = Path("simulated_patients/filtered")
...
MY_TEST_DATA = MY_DATA_DIR / f"disease_split_test_sim_patients_{CURR_KG}.txt"
